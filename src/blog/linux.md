...
I spent the day learning shortcuts, cloning repos, installing tools, basically just getting back to where I was Monday morning. I felt a bit more confident as the day went on, but didn't feel like I was the 10x CLI hyper productive warrior developer I have in mind when I think of developers working on Linux. I spent three years developing software on Windows just fine, but the more time I've spent with Docker, Terraform, GitHub Actions, pipelines, and other Linux native environments the more friction I felt. I will admit most of my terminal time is going back and forth with Claude Code. 
...
Today I spent more time practicing in the terminal between workflow deployments and build errors. I learned about aliases and ThePrimeagen himself would be proud that I modified my `.bashrc` with Neovim, that being said I'm still a Visual Studio Code fan, but with a bit more `code .` in my life. Then I learned about Wayland, Hyprland, and Waybar. Turns out adding a weather widget to what was formerly known as my "Start Bar" is creating a bash script with Claude and adding the personal touch. Changing the color and appearance of the widget? CSS, hey I know that. 

I still like design and I'm glad the world isn't just CLIs, but I'd be lying if I didn't feel more efficient this week. I'd like to thank David Hansson for Omarchy (I missed the boat on Ruby on Rails) and Sam for my open source operating system baptism.