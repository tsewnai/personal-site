...
I plugged in a mysterious hard drive with unknown contents, don't worry, I didn't find it on the ground outside. The stick had a fresh copy of [Omarchy](https://omarchy.org/). After my first initial log in and boot up (with my wireless keyboard and mouse were both plugged in) Sam slid over to my desk and started trying to fix my monitors. I've got two landscape and one portrait monitors that I previously had managed with Fancy Zones. After five minutes and a few LLM queries we had everything flipped, positioned, and refreshing correctly. Going from a mildly intuitive GUI in Fancy Zones to modifying text files by hand had me second guessing my choice to escape the chains of PowerShell.

I spent the day learning shortcuts, cloning repos, installing tools, basically just getting back to where I was Monday morning. I felt a little bit more confident as the day went on, but didn't feel like I was the 10x CLI hyper productive warrior developer I have in my mind when I think of developers working on Linux. I spent three years developing software on Windows just fine, but the more time I've spent with Docker, Terraform, pipelines, and other Linux native environments the more friction I felt. I will admit most of my terminal time is going back and forth with Claude Code. 
...
I still like design and I'm glad the world isn't just CLIs, but I'd be lying if I didn't feel a bit more efficient this week. I'd like to thank David Hansson for Omarchy (I missed the boat on Ruby on Rails) and Sam for my open source baptism.